...
from app.models import Base, Musician, MusicianType, Ensemble, EnsembleType, Composition
...
def performances_name(session: Session, insert_ensembles_data: List[Ensemble], insert_compositions_data: List[Composition]):
    pass
